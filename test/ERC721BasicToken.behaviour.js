...
import decodeLogs from '../test/decodeLogs';
import sendTransaction from '../test/sendTransaction';
...
export default function shouldBehaveLikeERC721BasicToken (accounts) {
  const firstTokenId = 21;
  const secondTokenId = 22;
  ...
  describe('like an ERC721BasicToken', function () {
    ...
    beforeEach(async function () {
      ...
      await this.token.mint(creator, 21, { from: manager });
      await this.token.mint(creator, 22, { from: manager });
    });
