 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract MNPRTToken is SupportsInterfaceWithLookup, ERC721, ERC721BasicToken, Ownable {
    ...
    // Token name
    string public name_ = "MiningProt Protocol Mining Token";

    // Token symbol
    string public symbol_ = "MNPRT";
